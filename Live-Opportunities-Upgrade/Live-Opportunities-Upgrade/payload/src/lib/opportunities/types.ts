...
export const platforms = ["linkedin", "x", "facebook", "instagram", "reddit", "threads", "bluesky", "tiktok"] as const;
...
export const settingsSchema = z.object({
  ...
  platforms: z.array(z.enum(platforms)).min(1).max(8).default([...platforms]),
...
export const labels: Record<Platform, string> = { linkedin: "LinkedIn", x: "X / Twitter", facebook: "Facebook", instagram: "Instagram", reddit: "Reddit", threads: "Threads", bluesky: "Bluesky", tiktok: "TikTok" };
